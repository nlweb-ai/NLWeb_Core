...
def main():
    ...
    print(f"    HTTP interface with SSE streaming (default) or JSON responses")
    ...
    print(f"      - streaming=<true|false> (optional, default: true)")
    print(f"")
    print(f"  - GET /health")
    print(f"    Health check endpoint")
    print(f"")
    print(f"  - POST /mcp")
    print(f"    MCP protocol endpoint (JSON-RPC 2.0 over HTTP)")
    print(f"    StreamableHTTP transport")
    print(f"")
    print(f"  - GET/POST /mcp-sse")
    print(f"    MCP protocol with Server-Sent Events streaming")
    print(f"")
    print(f"  - POST /a2a")
    print(f"    A2A protocol endpoint (JSON-RPC 2.0 over HTTP)")
    print(f"    StreamableHTTP transport")
    print(f"")
    print(f"  - GET/POST /a2a-sse")
    print(f"    A2A protocol with Server-Sent Events streaming")
    print(f"")
    print(f"\nExamples:")
    print(f"  HTTP GET (streaming):")
    print(f"    curl http://{host}:{port}/ask?query=best+pasta+recipe")
    print(f"")
    print(f"  HTTP GET (non-streaming):")
